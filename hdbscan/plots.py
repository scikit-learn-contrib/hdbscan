...
class CondensedTree(object):
    ...
    def plot(
        ...
        axis.invert_yaxis()
        axis.set_ylabel(r"$\lambda$ value")
...
class SingleLinkageTree(object):
    ...
    def plot(
        ...
        try:
            ...
            raise ImportError(
                "You must install the matplotlib library to plot the single linkage tree."
            )
...
class MinimumSpanningTree(object):
    ...
    def plot(
        ...
        try:
            ...
            raise ImportError(
                "You must install the matplotlib library to plot the minimum spanning tree."
            )
